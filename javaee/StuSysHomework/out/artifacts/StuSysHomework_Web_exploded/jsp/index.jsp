...
<div id="studentModal" class="modal">
    <div class="modal-content">
        ...
        <form id="studentForm" action="/student/save" method="post">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" for="department">院系 *</label>
    ...
    function setupEventListeners() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.classList.contains('edit-btn')) {
                ...
                // 填充表单数据
                studentId.value = btn.dataset.id;
                studentNo.value = btn.dataset.studentno;
                name.value = btn.dataset.name;
                genderSelect.value = btn.dataset.gender;
                age.value = btn.dataset.age;
                birthDate.value = btn.dataset.birthdate;
                phone.value = btn.dataset.phone;
                className.value = btn.dataset.classname;
                department.value = btn.dataset.department;
        ...
        studentForm.addEventListener('submit', function(e) {
            let isValid = true;
            const inputs = studentForm.querySelectorAll('input[required], select[required]');
